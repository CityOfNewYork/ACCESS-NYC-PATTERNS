(function () {
  ...
  var parent$1 = require('../../es/array/for-each');

  module.exports = parent$1;

  var parent$2 = require('../../es/object/assign');

  module.exports = parent$2;

  var parent$3 = require('../../stable/dom-collections/for-each');

  module.exports = parent$3;

  var parent$4 = require('../../stable/url-search-params');

  module.exports = parent$4;
  ...
  function ReplaceWithPolyfill() {
    ...
    var currentNode;
    if (!parent) { return; } // if there are no arguments

    if (!i) { parent.removeChild(this); }

    while (i--) {
      // i-- decrements i and returns the value of i before the decrement
      currentNode = arguments$1[i];
